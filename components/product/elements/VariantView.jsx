    ...
    <>
      {index % 2 === 0 ? (
        <div className="flex  rounded-lg ">
          ...
          <Link
            href={productUrl}
            className="cusros-pointer variant-bg rounded-lg overflow-hidden mx-auto w-full py-4 px-4 pr-16 text-white"
          >
            <div className="pb-4">
        ...
        <div className="flex rounded-lg ">
          <Link
            href={productUrl}
            className="cursor-pointer variant-bg-right rounded-lg overflow-hidden mx-auto w-full py-4 px-4 pl-16 text-white"
          >
            <div className="pb-4 ">
